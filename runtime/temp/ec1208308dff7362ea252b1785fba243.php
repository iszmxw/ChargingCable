<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./application/admin/view/index/index.html";i:1573454837;s:56:"/www/wwwroot/jdx/application/admin/view/public/left.html";i:1566530843;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="admincp-header">
	...
	<div class="admincp-name" onClick="javascript:openItem('welcome|Index');">
        ...
        <h1 style="text-align:center">机大呷</h1>
	</div>
	<div class="nc-module-menu">
		<ul class="nc-row">
            ...
            <!--<li data-param="hotel"><a href="javascript:void(0);">酒店录入</a></li>-->
