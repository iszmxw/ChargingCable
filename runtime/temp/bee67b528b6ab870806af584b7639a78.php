<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"./application/admin/view/subcommission/code_list.html";i:1574414968;s:58:"/www/wwwroot/jdx/application/admin/view/public/layout.html";i:1540260090;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="mDiv">
            ...
            <form class="navbar-form form-inline" id="search-form" action="" method="post" onsubmit="return check_form();">
                ...
                <div class="sDiv">
                    ...
                    <input type="text" size="30" name="bank" value="<?php echo $bank; ?>" id='bank' placeholder="设备号|酒店名" class="qsbox">
                ...
                <table>
                    ...
                    <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                        <tr>
                            ...
                            <td align="left" class="">
                                <div style="text-align: left; width: 50px;"><?php echo $list['id']; ?></div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 150px;"><?php echo $list['secret_key']; ?></div>
                            </td>
                            <td align="center" class="">
                            ...
                            <?php if($admin_id == 1): ?>
                                <td align="center" class="">
                                    <div style="text-align: center; width: 180px;">
                                        <?php if($list['mode_type'] == 1): ?>
                                            <font style="color: #ff0000">免费模式</font>
                                            <?php else: ?>
                                            默认模式
                                        <?php endif; ?>
                                        <a class="btn red"
                                           onclick="get_device_mode('<?php echo $list['number']; ?>','<?php echo $list['mode_type']; ?>',this)"
                                           href="javascript:;" data-url="<?php echo U('Subcommission/get_device_mode'); ?>"
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;"><?php echo $list['j_username']; ?></div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 150px;"><?php echo $list['hotel_name']; ?></div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;"><?php echo $list['j_mobile']; ?></div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;"><?php echo $list['f_username']; ?></div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;"><?php echo $list['f_mobile']; ?></div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;"><?php echo $list['admin']; ?></div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 150px;"><?php echo date("Y-m-d H:i",$list['time']); ?></div>
                            </td>
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    <a class="btn red"  href="javascript:void(0)" data-url="<?php echo U('Subcommission/delete_shebei'); ?>" data-id="<?php echo $list['id']; ?>" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
                                </div>
                            </td>
...
<script>
    ...
    function exportUser() {
        ...
        $('#search-form').attr('action',"<?php echo U('Subcommission/export_user'); ?>?bank="  + vals + '&timegap=' + timegap)
        $('#search-form').submit();
    }
