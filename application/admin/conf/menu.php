...
//			)),
    ...
    /*   'hotel'=>array('name'=>'酒店录入','child'=>array(
           array('name' => '酒店管理','child' => array(
               array('name' => '录入酒店', 'act'=>'add_hotel', 'op'=>'Hotel'),
               array('name' => '酒店列表', 'act'=>'lists', 'op'=>'Hotel'),
           )),
...
//					array('name' => '搭配购管理','act'=>'index', 'op'=>'Combination'),
    ...
    //           array('name' => '分佣规则设置', 'act'=>'index', 'op'=>'Subcommission'),
...
//					array('name' => '分销设置', 'act'=>'distribut', 'op'=>'System'),
    //array('name' => '购买干衣机分成日志', 'act'=>'rebate_log', 'op'=>'Distribut'),
    //		array('name' => '使用分润记录', 'act'=>'employ_list', 'op'=>'Distribut'),
    //)),
...
//			array('name'=>'会员等级','act'=>'levelList','op'=>'User'),
        ...
        array('name' => '提现管理', 'child' => array(
            ...
            /*  array('name'=>'提现协议','act'=>'agreement','op'=>'System'),*/
        )),
        //array('name' => '签到管理','child'=>array(
        //	array('name'=>'签到记录','act'=>'signList','op'=>'User'),
        //	array('name'=>'签到规则','act'=>'signRule','op'=>'User'),
        //)),
        /*array('name' => '维护卡总池管理','child'=>array(
            array('name'=>'充值维护卡总池','act'=>'add_pay_currency','op'=>'Subcommission'),
            array('name'=>'维护卡操作记录','act'=>'pay_currency_log','op'=>'Subcommission'),
        )),*/
        array('name' => '代理管理', 'child' => array(
            array('name' => '设备订单数据统计', 'act' => 'order_statistics', 'op' => 'Subcommission'),
            array('name' => '分佣规则设置', 'act' => 'index', 'op' => 'Subcommission'),
            array('name' => '总代申请列表', 'act' => 'apply_list', 'op' => 'Subcommission'),
            array('name' => '酒店列表', 'act' => 'hotel_list', 'op' => 'Subcommission'),
            array('name' => '分销商列表', 'act' => 'distributor_list', 'op' => 'Subcommission'),
            array('name' => '代理商列表', 'act' => 'agent_list', 'op' => 'Subcommission'),
            array('name' => '充电订单列表', 'act' => 'power_order', 'op' => 'Subcommission'),
            array('name' => '免费充电订单列表', 'act' => 'power_order_free', 'op' => 'Subcommission'),
            array('name' => '设备编号列表', 'act' => 'code_list', 'op' => 'Subcommission'),
        )),
        /*array('name' => '设备编号管理','child'=>array(
            array('name'=>'设备编号批量生成','act'=>'add_codelist','op'=>'Subcommission'),
            array('name'=>'设备编号列表','act'=>'code_list','op'=>'Subcommission'),
            array('name'=>'套餐列表','act'=>'package_price','op'=>'Subcommission'),
        )),*/
        /*array('name' => '设备管理','child'=>array(
            array('name'=>'添加设备','act'=>'add_codelist','op'=>'Subcommission'),
            array('name'=>'设备列表','act'=>'code_list','op'=>'Subcommission'),
            array('name'=>'套餐列表','act'=>'package_price','op'=>'Subcommission'),
            array('name'=>'充电订单','act'=>'power_order','op'=>'Subcommission'),
        )),*/

        /*array('name' => '协议设置','child'=>array(
            array('name'=>'干衣机使用协议','act'=>'clothes','op'=>'protocol'),
            array('name'=>'提现规则','act'=>'withdraw','op'=>'protocol'),
        )),*/
    )),
...
//	)),
    ...
    'data' => array('name' => '数据', 'child' => array(
        array('name' => '统计', 'child' => array(
            ...
            /*array('name' => '使用分润统计', 'act'=>'employ_analysis', 'op'=>'Report'),*/
