...
//        file_put_contents('./wxpay.txt', date('Ymd H:i').'：'.json_encode(['mchid'=>$config_value['mchid'],'key'=>$config_value['key']]). "\r\n",FILE_APPEND);
//        file_put_contents('./wxpay.txt', date('Ymd H:i').'：'.json_encode([$code]). "\r\n",FILE_APPEND);
