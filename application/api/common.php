 ...
 * @return array
 */
function returnBad($msg,$errorCode = 10000,$data=[]){
    return json([
        'code' => $errorCode,
        'msg'  => $msg,
        'data' => $data,
 ...
 * @return array   $info
 */
function pageReturn($data=[],$page = 1,$pagesize=10)
{
    ...
    $idx = 0;
    $info = [];
    //dump($pageStart);dump($pageEnd);exit;
    $info["data"] = [];
    ...
    $info["total_page"] = ceil(count($data)/$pagesize);
